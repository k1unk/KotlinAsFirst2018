...
fun circleByDiameter(diameter: Segment): Circle {
    val middleX = (diameter.begin.x + diameter.end.x) / 2
    val middleY = (diameter.begin.y + diameter.end.y) / 2
